            ...
            switch (member.V.kind) {
              ...
              case "enum":
                if (member.V.T === ScalarType.BYTES) {
                  for (const [k2, v3] of Object.entries(s2[localName])) {
    ...
    equals(type, a3, b2) {
      ...
      return type.fields.byMember().every((m3) => {
        ...
        if (m3.repeated) {
          ...
          switch (m3.kind) {
            case "message":
              return va.every((a4, i2) => m3.T.equals(a4, vb[i2]));
            case "scalar":
              return va.every((a4, i2) => scalarEquals(m3.T, a4, vb[i2]));
            case "enum":
...
function r(r4, e3, n2) {
  ...
  var a3 = null != (i2 = n2.isImmediate) && i2, u3 = null != (t = n2.callback) && t, c3 = n2.maxWait, v3 = Date.now(), l2 = [];
  function f2() {
    if (void 0 !== c3) {
      var r5 = Date.now() - v3;
      if (r5 + e3 >= c3)
...
function a() {
  return a = Object.assign ? Object.assign.bind() : function(e3) {
    for (var t = 1; t < arguments.length; t++) {
      var n2 = arguments[t];
      for (var o3 in n2)
        ({}).hasOwnProperty.call(n2, o3) && (e3[o3] = n2[o3]);
    }
    return e3;
...
var r2 = class {
  ...
  async handleClientToolCall(e3) {
    if (Object.prototype.hasOwnProperty.call(this.options.clientTools, e3.client_tool_call.tool_name))
      try {
        var t;
      ...
      if (this.options.onUnhandledClientToolCall)
        return void this.options.onUnhandledClientToolCall(e3.client_tool_call);
...
function l(e3) {
  ...
  if (!["pcm", "ulaw"].includes(t))
    throw new Error(`Invalid format: ${e3}`);
...
var m = class _m extends c {
  constructor(e3, t, n2, o3) {
    super(), this.socket = void 0, this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.socket = e3, this.conversationId = t, this.inputFormat = n2, this.outputFormat = o3, this.socket.addEventListener("error", (e4) => {
      ...
      try {
        ...
        if (!d(t2))
          return void this.debug({ type: "invalid_event", message: "Received invalid socket event", data: e4.data });
  ...
  static async create(e3) {
    ...
    try {
      var n2, o3, s2;
      const a4 = null != (n2 = e3.origin) ? n2 : "wss://api.elevenlabs.io";
      let i2;
      const r4 = (null == (o3 = e3.overrides) || null == (o3 = o3.client) ? void 0 : o3.version) || u, c3 = (null == (s2 = e3.overrides) || null == (s2 = s2.client) ? void 0 : s2.source) || "js_sdk";
      if (e3.signedUrl) {
        const t2 = e3.signedUrl.includes("?") ? "&" : "?";
        i2 = `${e3.signedUrl}${t2}source=${c3}&version=${r4}`;
      } else
        i2 = `${a4}/v1/convai/conversation?agent_id=${e3.agentId}&source=${c3}&version=${r4}`;
      const h3 = ["convai"];
      e3.authorization && h3.push(`bearer.${e3.authorization}`), t = new WebSocket(i2, h3);
      const v3 = await new Promise((n3, o4) => {
        t.addEventListener("open", () => {
          ...
          setTimeout(() => o4(e4), 0);
        }), t.addEventListener("close", o4), t.addEventListener("message", (e4) => {
          const t2 = JSON.parse(e4.data);
      ...
      }), { conversation_id: g2, agent_output_audio_format: f2, user_input_audio_format: _3 } = v3, w2 = l(null != _3 ? _3 : "pcm_16000"), b2 = l(f2);
      return new _m(t, g2, w2, b2);
    } catch (e4) {
      var a3;
      throw null == (a3 = t) || a3.close(), e4;
    }
  }
  close() {
...
function _2(e3, t) {
  return async (n2, o3) => {
    const s2 = f.get(e3);
    if (s2)
      return n2.addModule(s2);
    if (o3)
      try {
        return await n2.addModule(o3), void f.set(e3, o3);
      } catch (t2) {
        throw new Error(`Failed to load the ${e3} worklet module from path: ${o3}. Error: ${t2}`);
      }
    const a3 = new Blob([t], { type: "application/javascript" }), i2 = URL.createObjectURL(a3);
    try {
      return await n2.addModule(i2), void f.set(e3, i2);
    } catch (e4) {
      URL.revokeObjectURL(i2);
    }
    try {
      const o4 = `data:application/javascript;base64,${btoa(t)}`;
      await n2.addModule(o4), f.set(e3, o4);
    } catch (t2) {
...
var b = class _b extends c {
  constructor(e3, t, n2, o3, s2 = {}) {
    super(s2), this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.room = void 0, this.isConnected = false, this.audioEventId = 1, this.audioCaptureContext = null, this.audioElements = [], this.outputDeviceId = null, this.outputAnalyser = null, this.outputFrequencyData = null, this.room = e3, this.conversationId = t, this.inputFormat = n2, this.outputFormat = o3, this.setupRoomEventListeners();
  }
  static async create(n2) {
    let o3;
    if ("conversationToken" in n2 && n2.conversationToken)
      o3 = n2.conversationToken;
    else {
      if (!("agentId" in n2) || !n2.agentId)
        throw new Error("Either conversationToken or agentId is required for WebRTC connection");
      try {
        var s2, a3, i2;
        const e3 = (null == (s2 = n2.overrides) || null == (s2 = s2.client) ? void 0 : s2.version) || u, t = (null == (a3 = n2.overrides) || null == (a3 = a3.client) ? void 0 : a3.source) || "js_sdk", c4 = `${r4 = null != (i2 = n2.origin) ? i2 : "https://api.elevenlabs.io", r4.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n2.agentId}&source=${t}&version=${e3}`, l2 = await fetch(c4);
        if (!l2.ok)
          throw new Error(`ElevenLabs API returned ${l2.status} ${l2.statusText}`);
        if (o3 = (await l2.json()).token, !o3)
    ...
    const c3 = new Room();
    try {
      const e3 = `room_${Date.now()}`, s3 = l("pcm_48000"), a4 = l("pcm_48000"), i3 = new _b(c3, e3, s3, a4, n2), r5 = n2.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      var d3;
      ...
      }), c3.name && (i3.conversationId = (null == (d3 = c3.name.match(/(conv_[a-zA-Z0-9]+)/)) ? void 0 : d3[0]) || c3.name), await c3.localParticipant.setMicrophoneEnabled(true);
      const u3 = p(n2);
  ...
  setupRoomEventListeners() {
    ...
    }), this.room.on(RoomEvent.TrackSubscribed, async function(t, n2, s2) {
      if (t.kind === Track.Kind.Audio && s2.identity.includes("agent")) {
        const n3 = t, o3 = n3.attach();
        if (o3.autoplay = true, o3.controls = false, e3.outputDeviceId && o3.setSinkId)
          try {
  ...
  async setupAudioCapture(e3) {
    try {
      ...
      o3.connect(this.outputAnalyser), await w(t.audioWorklet);
      const s2 = new AudioWorkletNode(t, "rawAudioProcessor");
      this.outputAnalyser.connect(s2), s2.port.postMessage({ type: "setFormat", format: this.outputFormat.format, sampleRate: this.outputFormat.sampleRate }), s2.port.onmessage = (e4) => {
        const [t2, n3] = e4.data;
        if (n3 > 0.01) {
          const e5 = v(t2.buffer), n4 = this.audioEventId++;
  ...
  async setAudioInputDevice(e3) {
    ...
    try {
      ...
      const n2 = { deviceId: { exact: e3 }, echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } }, a3 = await createLocalAudioTrack(n2);
      await this.room.localParticipant.publishTrack(a3, { name: "microphone", source: Track.Source.Microphone });
    } catch (e4) {
...
var k = class _k extends r2 {
  static async startSession(e3) {
    ...
    let n2 = null;
    try {
      return await E(t.connectionDelay), n2 = await y(e3), new _k(t, n2);
    } catch (e4) {
      var o3;
...
var M = class _M {
  static async create({ sampleRate: e3, format: t, preferHeadphonesForIosDevices: n2, inputDeviceId: o3, workletPaths: s2, libsampleratePath: i2 }) {
    let r4 = null, c3 = null;
    try {
      const l3 = a({ sampleRate: { ideal: e3 } }, C);
      if (S() && n2) {
      ...
      await w(r4.audioWorklet, null == s2 ? void 0 : s2.rawAudioProcessor);
  ...
  static getDeviceIdConstraint(e3) {
    if (e3)
      return S() ? { ideal: e3 } : { exact: e3 };
  }
  constructor(e3, t, n2, o3, s2) {
    this.context = void 0, this.analyser = void 0, this.worklet = void 0, this.inputStream = void 0, this.mediaStreamSource = void 0, this.context = e3, this.analyser = t, this.worklet = n2, this.inputStream = o3, this.mediaStreamSource = s2;
  }
  async close() {
  ...
  async setInputDevice(e3) {
    try {
      ...
      const n2 = a({ voiceIsolation: true }, t), o3 = await navigator.mediaDevices.getUserMedia({ audio: n2 });
...
var R = class _R {
  static async create({ sampleRate: e3, format: t, outputDeviceId: n2, workletPaths: o3 }) {
    let s2 = null, a3 = null;
    try {
      s2 = new AudioContext({ sampleRate: e3 });
      const i3 = s2.createAnalyser(), r5 = s2.createGain();
      a3 = new Audio(), a3.src = "", a3.load(), a3.autoplay = true, a3.style.display = "none", document.body.appendChild(a3);
      const c3 = s2.createMediaStreamDestination();
      a3.srcObject = c3.stream, r5.connect(i3), i3.connect(c3), await I(s2.audioWorklet, null == o3 ? void 0 : o3.audioConcatProcessor);
      const l2 = new AudioWorkletNode(s2, "audioConcatProcessor");
      return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r5), await s2.resume(), n2 && a3.setSinkId && await a3.setSinkId(n2), new _R(s2, i3, r5, l2, a3);
    } catch (e4) {
      var i2, r4;
      throw null != (i2 = a3) && i2.parentNode && a3.parentNode.removeChild(a3), null == (r4 = a3) || r4.pause(), s2 && "closed" !== s2.state && await s2.close(), e4;
    }
  }
  constructor(e3, t, n2, o3, s2) {
    this.context = void 0, this.analyser = void 0, this.gain = void 0, this.worklet = void 0, this.audioElement = void 0, this.context = e3, this.analyser = t, this.gain = n2, this.worklet = o3, this.audioElement = s2;
  }
...
var A = class _A extends r2 {
  static async startSession(e3) {
    ...
    let o3 = null, s2 = null, i2 = null, c3 = null, l2 = null;
    if (null == (t = e3.useWakeLock) || t)
      try {
    ...
    try {
      var u3;
      return c3 = await navigator.mediaDevices.getUserMedia({ audio: true }), await E(n2.connectionDelay), s2 = await y(e3), [o3, i2] = await Promise.all([M.create(a({}, s2.inputFormat, { preferHeadphonesForIosDevices: e3.preferHeadphonesForIosDevices, inputDeviceId: e3.inputDeviceId, workletPaths: e3.workletPaths, libsampleratePath: e3.libsampleratePath })), R.create(a({}, s2.outputFormat, { outputDeviceId: e3.outputDeviceId, workletPaths: e3.workletPaths }))]), null == (u3 = c3) || u3.getTracks().forEach((e4) => {
        e4.stop();
      }), c3 = null, new _A(n2, s2, o3, i2, l2);
    } catch (e4) {
      var d3, h3, p2, m3;
      n2.onStatusChange && n2.onStatusChange({ status: "disconnected" }), null == (d3 = c3) || d3.getTracks().forEach((e5) => {
        e5.stop();
      }), null == (h3 = s2) || h3.close(), await (null == (p2 = o3) ? void 0 : p2.close()), await (null == (m3 = i2) ? void 0 : m3.close());
      try {
        var v3;
  ...
  constructor(e3, t, n2, o3, s2) {
    super(e3, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.onInputWorkletMessage = (e4) => {
      "connected" === this.status && this.connection.sendMessage({ user_audio_chunk: v(e4.data[0].buffer) });
      ...
      this.output.gain.gain.cancelScheduledValues(this.output.context.currentTime), this.output.gain.gain.value = this.volume, this.output.worklet.port.postMessage({ type: "clearInterrupted" }), this.output.worklet.port.postMessage({ type: "buffer", buffer: g(e4) });
    }, this.fadeOutAudio = () => {
    ...
    }, this.input = n2, this.output = o3, this.wakeLock = s2, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.output.worklet.port.onmessage = this.onOutputWorkletMessage;
  }
  async handleEndSession() {
  ...
  handleAudio(e3) {
    var t, n2;
    this.lastInterruptTimestamp <= e3.audio_event.event_id && (null == (t = (n2 = this.options).onAudio) || t.call(n2, e3.audio_event.audio_base_64), this.connection instanceof b || this.addAudioBase64Chunk(e3.audio_event.audio_base_64), this.currentEventId = e3.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
  }
  setMicMuted(e3) {
    this.connection instanceof b ? this.connection.setMicMuted(e3) : this.input.setMuted(e3);
  }
  getInputByteFrequencyData() {
  ...
  async changeInputDevice({ sampleRate: e3, format: t, preferHeadphonesForIosDevices: n2, inputDeviceId: o3 }) {
    try {
      ...
      this.connection instanceof b && await this.connection.setAudioInputDevice(o3 || ""), await this.input.close();
      const s2 = await M.create({ sampleRate: null != e3 ? e3 : this.connection.inputFormat.sampleRate, format: null != t ? t : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n2, inputDeviceId: o3, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath });
      return this.input = s2, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.input;
    } catch (e4) {
  ...
  async changeOutputDevice({ sampleRate: e3, format: t, outputDeviceId: n2 }) {
    try {
      ...
      this.connection instanceof b && await this.connection.setAudioOutputDevice(n2 || ""), await this.output.close();
      const o3 = await R.create({ sampleRate: null != e3 ? e3 : this.connection.outputFormat.sampleRate, format: null != t ? t : this.connection.outputFormat.format, outputDeviceId: n2, workletPaths: this.options.workletPaths });
...
var P = class {
  constructor(e3) {
    this.websocket = null, this.eventEmitter = new D(), this.currentSampleRate = 16e3, this._audioCleanup = void 0, this.currentSampleRate = e3;
  }
  setWebSocket(e3) {
    this.websocket = e3, this.websocket.readyState === WebSocket.OPEN ? this.eventEmitter.emit(F.OPEN) : this.websocket.addEventListener("open", () => {
      ...
      try {
        ...
        console.error("Failed to parse WebSocket message:", t, e4.data), this.eventEmitter.emit(F.ERROR, new Error(`Failed to parse message: ${t}`));
      }
    }), this.websocket.addEventListener("error", (e4) => {
      console.error("WebSocket error:", e4), this.eventEmitter.emit(F.ERROR, e4);
      ...
      this.eventEmitter.emit(F.CLOSE, e4);
    });
  }
  on(e3, t) {
...
var L = class _L {
  static getWebSocketUri(e3 = _L.DEFAULT_BASE_URI) {
    return `${e3}/v1/speech-to-text/realtime`;
  }
  static buildWebSocketUri(e3) {
    const t = _L.getWebSocketUri(e3.baseUri), n2 = new URLSearchParams();
    if (n2.append("model_id", e3.modelId), n2.append("token", e3.token), void 0 !== e3.commitStrategy && n2.append("commit_strategy", e3.commitStrategy), void 0 !== e3.audioFormat && n2.append("audio_format", e3.audioFormat), void 0 !== e3.vadSilenceThresholdSecs) {
      if (e3.vadSilenceThresholdSecs <= 0.3 || e3.vadSilenceThresholdSecs > 3)
    ...
    if (void 0 !== e3.vadThreshold) {
      if (e3.vadThreshold < 0.1 || e3.vadThreshold > 0.9)
    ...
    if (void 0 !== e3.minSpeechDurationMs) {
      if (e3.minSpeechDurationMs <= 50 || e3.minSpeechDurationMs > 2e3)
    ...
    if (void 0 !== e3.minSilenceDurationMs) {
      if (e3.minSilenceDurationMs <= 50 || e3.minSilenceDurationMs > 2e3)
  ...
  static connect(e3) {
    ...
    const t = new P("microphone" in e3 && e3.microphone ? 16e3 : e3.sampleRate), n2 = _L.buildWebSocketUri(e3), o3 = new WebSocket(n2);
    return "microphone" in e3 && e3.microphone && o3.addEventListener("open", () => {
      _L.streamFromMicrophone(e3, t);
    }), t.setWebSocket(o3), t;
  }
  static async streamFromMicrophone(e3, t) {
    try {
      var n2, o3, s2, a3, i2, r4, c3, l2, u3;
      const d3 = await navigator.mediaDevices.getUserMedia({ audio: { deviceId: null == (n2 = e3.microphone) ? void 0 : n2.deviceId, echoCancellation: null == (o3 = null == (s2 = e3.microphone) ? void 0 : s2.echoCancellation) || o3, noiseSuppression: null == (a3 = null == (i2 = e3.microphone) ? void 0 : i2.noiseSuppression) || a3, autoGainControl: null == (r4 = null == (c3 = e3.microphone) ? void 0 : c3.autoGainControl) || r4, channelCount: null != (l2 = null == (u3 = e3.microphone) ? void 0 : u3.channelCount) ? l2 : 1, sampleRate: { ideal: 16e3 } } }), h3 = new AudioContext({ sampleRate: 16e3 });
      await x(h3.audioWorklet);
      const p2 = h3.createMediaStreamSource(d3), m3 = new AudioWorkletNode(h3, "scribeAudioProcessor");
      m3.port.onmessage = (e4) => {
        const { audioData: n3 } = e4.data, o4 = new Uint8Array(n3);
        let s3 = "";
        for (let e5 = 0; e5 < o4.length; e5++)
          s3 += String.fromCharCode(o4[e5]);
        const a4 = btoa(s3);
        t.send({ audioBase64: a4 });
      }, p2.connect(m3), "suspended" === h3.state && await h3.resume(), t._audioCleanup = () => {
        d3.getTracks().forEach((e4) => {
          e4.stop();
        }), p2.disconnect(), m3.disconnect(), h3.close();
      };
    } catch (e4) {
...
var N = class extends r2 {
  static startSession(e3) {
    return e3.textOnly ? k.startSession(e3) : A.startSession(e3);
  }
};
...
function a2(i2 = {}) {
  const { onSessionStarted: a3, onPartialTranscript: s2, onCommittedTranscript: c3, onCommittedTranscriptWithTimestamps: d3, onError: v3, onAuthError: m3, onQuotaExceededError: g2, onCommitThrottledError: p2, onTranscriberError: T2, onUnacceptedTermsError: h3, onRateLimitedError: C2, onInputError: S2, onQueueOverflowError: E2, onResourceExhaustedError: M2, onSessionTimeLimitExceededError: I2, onChunkSizeExceededError: D2, onInsufficientAudioActivityError: w2, onConnect: R2, onDisconnect: b2, token: y2, modelId: A2, baseUri: f2, commitStrategy: O2, vadSilenceThresholdSecs: U2, vadThreshold: k2, minSpeechDurationMs: F2, minSilenceDurationMs: _3, languageCode: P2, microphone: x2, audioFormat: N2, sampleRate: V, autoConnect: L2 = false, includeTimestamps: q } = i2, B = (0, import_react.useRef)(null), [H, $] = (0, import_react.useState)("disconnected"), [Q, W] = (0, import_react.useState)(""), [X, j] = (0, import_react.useState)([]), [z, K] = (0, import_react.useState)(null);
  ...
  const Y = (0, import_react.useCallback)(async (n2 = {}) => {
    if (B.current)
      ...
      try {
        var e3, r4;
        $("connecting"), K(null);
        const o3 = n2.token || y2, i3 = n2.modelId || A2;
        if (!o3)
        ...
        B.current = Q2, Q2.on(F.SESSION_STARTED, () => {
          $("connected"), null == a3 || a3();
        }), Q2.on(F.PARTIAL_TRANSCRIPT, (n3) => {
          const e4 = n3;
          W(e4.text), $("transcribing"), null == s2 || s2(e4);
        }), Q2.on(F.COMMITTED_TRANSCRIPT, (n3) => {
          const e4 = n3, r5 = { id: `${Date.now()}-${Math.random()}`, text: e4.text, timestamp: Date.now(), isFinal: true };
          j((n4) => [...n4, r5]), W(""), null == c3 || c3(e4);
        }), Q2.on(F.COMMITTED_TRANSCRIPT_WITH_TIMESTAMPS, (n3) => {
          const e4 = n3, r5 = { id: `${Date.now()}-${Math.random()}`, text: e4.text, timestamp: Date.now(), isFinal: true, words: e4.words };
          j((n4) => [...n4, r5]), W(""), null == d3 || d3(e4);
        }), Q2.on(F.ERROR, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == v3 || v3(new Error(e4.error));
        }), Q2.on(F.AUTH_ERROR, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == m3 || m3(e4);
        }), Q2.on(F.QUOTA_EXCEEDED, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == g2 || g2(e4);
        }), Q2.on(F.COMMIT_THROTTLED, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == p2 || p2(e4);
        }), Q2.on(F.TRANSCRIBER_ERROR, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == T2 || T2(e4);
        }), Q2.on(F.UNACCEPTED_TERMS, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == h3 || h3(e4);
        }), Q2.on(F.RATE_LIMITED, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == C2 || C2(e4);
        }), Q2.on(F.INPUT_ERROR, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == S2 || S2(e4);
        }), Q2.on(F.QUEUE_OVERFLOW, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == E2 || E2(e4);
        }), Q2.on(F.RESOURCE_EXHAUSTED, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == M2 || M2(e4);
        }), Q2.on(F.SESSION_TIME_LIMIT_EXCEEDED, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == I2 || I2(e4);
        }), Q2.on(F.CHUNK_SIZE_EXCEEDED, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == D2 || D2(e4);
        }), Q2.on(F.INSUFFICIENT_AUDIO_ACTIVITY, (n3) => {
          const e4 = n3;
          K(e4.error), $("error"), null == w2 || w2(e4);
        }), Q2.on(F.OPEN, () => {
          null == R2 || R2();
        }), Q2.on(F.CLOSE, () => {
          $("disconnected"), B.current = null, null == b2 || b2();
        });
      } catch (n3) {
        const e4 = n3 instanceof Error ? n3.message : "Failed to connect";
        throw K(e4), $("error"), n3;
      }
  }, [y2, A2, f2, O2, U2, k2, F2, _3, P2, x2, N2, V, q, a3, s2, c3, d3, v3, m3, g2, p2, T2, h3, C2, S2, E2, M2, I2, D2, w2, R2, b2]), Z = (0, import_react.useCallback)(() => {
    var n2;
...
function m2(o3 = {}) {
  const { micMuted: t, volume: l2, serverLocation: a3 } = o3, m3 = function(n2, e3) {
    if (null == n2)
      return {};
    var r4 = {};
    for (var o4 in n2)
    ...
    return r4;
  }(o3, s), g2 = (0, import_react.useRef)(null), p2 = (0, import_react.useRef)(null), T2 = (0, import_react.useRef)(false), [h3, C2] = (0, import_react.useState)("disconnected"), [S2, E2] = (0, import_react.useState)(false), [M2, I2] = (0, import_react.useState)("listening"), D2 = (0, import_react.useRef)(t), w2 = (0, import_react.useRef)(l2);
  return D2.current = t, w2.current = l2, (0, import_react.useEffect)(() => {
    ...
    var e3;
    if (null != (e3 = g2.current) && e3.isOpen())
    ...
    if (g2.current = null, n2) {
      ...
      await (null == e3 ? void 0 : e3.endSession());
  }, setVolume: ({ volume: n2 }) => {
    var e3;
